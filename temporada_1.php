...
<head>
    ...
    <title>SquidGameFans - Temporada 1</title>
...
<body>
    ...
    <nav class="navbar" id="navbar">
        ...
        <ul class="menu" id="menu">
            ...
            <li><a class="item-menu-activo" href="temporada_1.php">Temporada 1</a></li>
 ...
 <div class="seccion-temporada">
    <h1>Squid Game - Temporada 1</h1>

    <p>
      La primera temporada de <strong>Squid Game</strong> sigue a 456 personas con grandes problemas económicos que aceptan una misteriosa invitación para competir en juegos infantiles. El premio: 45.6 mil millones de wones. Sin embargo, lo que parece un juego inocente se transforma en una lucha brutal por la supervivencia, donde cada ronda pone en riesgo sus vidas. La serie explora la desigualdad, la desesperación y la condición humana en situaciones extremas.
    </p>

    <iframe class="video-temporada" src="https://www.youtube.com/embed/oqxAJKy0ii4" allowfullscreen></iframe>
  </div>
    ...
    <table id="playerTable">
      ...
      <tbody>
        <tr>
          <td>456</td>
          <td>Seong Gi-hun</td>
          <td>Chofer desempleado</td>
          <td>Protagonista. Un hombre endeudado que participa para ayudar a su hija y a su madre enferma.</td>
        </tr>
        <tr>
          <td>218</td>
          <td>Cho Sang-woo</td>
          <td>Exdirector financiero</td>
          <td>Amigo de la infancia de Gi-hun, enfrenta cargos por malversación.</td>
        </tr>
        <tr>
          <td>067</td>
          <td>Kang Sae-byeok</td>
          <td>Desertora norcoreana</td>
          <td>Busca dinero para reunir a su familia y cuidar de su hermano menor.</td>
        </tr>
        <tr>
          <td>001</td>
          <td>Oh Il-nam</td>
          <td>Anciano</td>
          <td>El jugador más viejo. Tiene un tumor cerebral, pero guarda un gran secreto.</td>
        </tr>
        <tr>
          <td>101</td>
          <td>Jang Deok-su</td>
          <td>Gánster</td>
          <td>Un criminal violento que se une al juego para huir de sus deudas.</td>
        </tr>
        <tr>
          <td>212</td>
          <td>Han Mi-nyeo</td>
          <td>Estafadora</td>
          <td>Personaje excéntrico y manipulador que intenta sobrevivir a toda costa.</td>
        </tr>
        <tr>
          <td>199</td>
          <td>Ali Abdul</td>
          <td>Trabajador migrante</td>
          <td>Pakistaní que participa en el juego para mantener a su familia tras ser explotado por su empleador.</td>
        </tr>
      </tbody>
    </table>
  </div>
