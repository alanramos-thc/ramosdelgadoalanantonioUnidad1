...
<head>
    ...
    <title>SquidGameFans - Iniciar Sesión</title>
...
<body>
    ...
    <nav class="navbar" id="navbar">
        ...
        <ul class="menu" id="menu">
            ...
            <li><a class="item-menu-activo" href="iniciar_sesion.php">Iniciar Sesión</a></li>
    ...
    <section class="seccion-iniciar-sesion">
        <div class="informacion-iniciar-sesion">
            <h1>Recibiste la tarjeta, aceptaste la invitación... ahora estás aquí.</h1>
            <p>Explora el lado oculto del juego.</p>
        </div>
        <div class="formulario-iniciar-sesion">
            ...
            ?>
            <form action="backend/iniciar-sesion.php" method="post">
                ...
                <div class="contrasena-usuario">
                    <label for="contrasenaUsuario">Contraseña<span>*</span></label><br>
                    <input type="password" name="contrasena_usuario" id="contrasenaUsuario" required>
                </div>
                <div class="link-olvide-mi-contrasena">
                    <a href="recuperar_contrasena.php">Olvidé mi contraseña</a>
                </div>
                <script src="https://www.google.com/recaptcha/api.js" async defer></script>
                <div class="g-recaptcha" data-sitekey="6Lemel4rAAAAAMAaacl-9-ytCQnlsVLZ8zG-JfNP"></div>
